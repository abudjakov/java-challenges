...
public class LowestCommonAncestor {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("lca: " + lca(root, 3, 8)); // 7
        System.out.println("lca: " + lca(root, 6, 8)); // 6
        System.out.println("lca: " + lca(root, 1, 8)); // 6
        System.out.println("lca: " + lca(root, 7, 10)); // 7
        System.out.println("lca: " + lca(root, 11, 10)); // null
